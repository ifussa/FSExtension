...
#pragma mark Screen
/// 屏幕高度、宽度
#define fs_kWidth [[UIScreen mainScreen] bounds].size.width
#define fs_kHeight [[UIScreen mainScreen] bounds].size.height

///iphone x适配相关
// 是否是刘海屏
#define fs_isiPhoneXScreen [FSApp isiPhoneXScreen]

//iphone x StatusBar+NavigationBar高度
#define fs_kSafeAreaTopHeight (fs_isiPhoneXScreen ? 88 : 64)

//iphone x 底部圆角区域高度
#define fs_kSafeAreaBottomHeight (fs_isiPhoneXScreen ? 34 : 0)

//iphone x StatusBar高度
#define fs_kSafeAreaStatusBarHeight (fs_isiPhoneXScreen ? 44 : 20)

//iphone x TabBar+底部圆角区域高度
#define fs_kSafeAreaTabBarHeight (fs_isiPhoneXScreen ? 83 : 49)
